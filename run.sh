...
# ResNet50-IBN-a
CUDA_VISIBLE_DEVICES=0 python train.py --config_file configs/stage1/50a_384.yml MODEL.DEVICE_ID "('0')"
# python train_stage2_v1.py --config_file configs/stage2/50a_384.yml MODEL.DEVICE_ID "('0')" OUTPUT_DIR './logs/stage2/50a_384/v1'
# python train_stage2_v2.py --config_file configs/stage2/50a_384.yml MODEL.DEVICE_ID "('0')" OUTPUT_DIR './logs/stage2/50a_384/v2'
...
# ResNet101-IBN-a
# CUDA_VISIBLE_DEVICES=1 python train.py --config_file configs/stage1/101a_384.yml MODEL.DEVICE_ID "('1')"
