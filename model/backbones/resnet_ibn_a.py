...
class ResNet_IBN(nn.Module):
    ...
    def __init__(self, last_stride, block, layers, frozen_stages=-1,num_classes=1000):
        ...
        self.layer1 = self._make_layer(block, scale, layers[0]) #64
        self.layer2 = self._make_layer(block, scale*2, layers[1], stride=2) #128
        self.layer3 = self._make_layer(block, scale*4, layers[2], stride=2) #256
        self.layer4 = self._make_layer(block, scale*8, layers[3], stride=last_stride) #512
